...
function ramp(colorFn, n = 256) {
  let color
  // Test if color is continuous or discrete
  if (colorFn[0]) {
    console.log(color)
    // if discrete then convert array to interpolation function
    color = d3.interpolate(colorFn[0])(colorFn[colorFn.length - 1])
  } else {
    color = colorFn
  }
...
// Add DOM.canvas utility from observable standard library
